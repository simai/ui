...
class Fab extends _core_js_ComponentObserver__WEBPACK_IMPORTED_MODULE_0__.ComponentObserver {
  ...
  scrollSetup() {
    if (window.scrollY > 200) {
      this.button.classList.replace('opacity-0', 'opacity-full');
      this.button.classList.replace('invisible', 'visible');
    } else {
      this.button.classList.replace('opacity-full', 'opacity-0');
      this.button.classList.replace('visible', 'invisible');
    }
  }
  ...
  destroyInternal() {
    ...
    this.button.removeEventListener('click', this.top);
  }

}

(0,_register_helper__WEBPACK_IMPORTED_MODULE_1__["default"])('Fab', Fab);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fab__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("74707b8679c1");
/*
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scss_index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("ea31ca3840f4");
/* harmony import */ var _js_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("fc73858fdfad");
/**
 * SIMAI Framework
