...
def build_registry(
    ...
    lock_path = release_lock_path or ui_root / "contracts/releases/ui-cb1cda301648-smart-81741eac168d.lock.json"
    reference_path = smart_reference_path or ui_root / "contracts/registry-inputs/ui-smart-a4a417221f78.ref.json"
    manifests = {
