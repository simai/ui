...
def build_registry(
    ...
    lock_path = release_lock_path or ui_root / "contracts/releases/ui-ad7f6bfaf355-smart-577bd99f8c6d.lock.json"
    reference_path = smart_reference_path or ui_root / "contracts/registry-inputs/ui-smart-577bd99f8c6d.ref.json"
    manifests = {
