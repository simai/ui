...
def build_registry(
    ...
    lock_path = release_lock_path or ui_root / "contracts/releases/ui-1e886550a147-smart-77feccf8867a.lock.json"
    reference_path = smart_reference_path or ui_root / "contracts/registry-inputs/ui-smart-ee516ca2eb83.ref.json"
    manifests = {
