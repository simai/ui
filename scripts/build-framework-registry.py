...
def build_registry(
    ...
    lock_path = release_lock_path or ui_root / "contracts/releases/ui-d81ccde2bdd5-smart-004424a4b2e9.lock.json"
    reference_path = smart_reference_path or ui_root / "contracts/registry-inputs/ui-smart-f871a0f2530b.ref.json"
    manifests = {
