...
Текущая локальная версия-кандидат: `5.8.0`. Она предназначена для проверки до публикации; последняя опубликованная версия — `5.7.0`.
...
Состав локальной версии-кандидата `5.8.0`:
