...
LOCK = ROOT / "contracts/releases/ui-aa74f029c1b4-smart-77feccf8867a.lock.json"
SMART_REFERENCE = ROOT / "contracts/registry-inputs/ui-smart-ee516ca2eb83.ref.json"
...
class FrameworkContractRegistryTest(unittest.TestCase):
    ...
    def test_positive_inventory_pair_and_recipe_closure(self) -> None:
        ...
        self.assertEqual(
            ...
            "ui-aa74f029c1b4-smart-77feccf8867a",
        )
    ...
    def test_no_copy_smart_pointer_and_wrong_reference_hash(self) -> None:
        ...
        self.assertEqual(
            ...
            "ee516ca2eb8323bb20cd6214798b3f54295ae3d9",
        )
